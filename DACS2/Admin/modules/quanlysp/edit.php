<?php 
    $sql_edit_sp = "SELECT * FROM tbl_sanpham WHERE id_sanpham='$_GET[idsanpham]' LIMIT 1";
    $query_edit_sp = mysqli_query($mysqli, $sql_edit_sp);
?>
<h1>Sửa Sản Phẩm</h1>
    <table border="1" width="100%" style="border-collapse: collapse;">
    <?php
    while($row = $query_edit_sp -> fetch_array()){
    ?>
        <form method="POST" action="modules/quanlysp/xuly.php?idsanpham=<?php echo $row['id_sanpham']?>" enctype="multipart/form-data">
            ...
            <tr>
                <td>Nội Dung</td>
                <td><textarea rows="10" name="chitiet" style="resize: none;"><?php echo $row['chitiet']?></textarea></td>
            </tr>
            <tr>
