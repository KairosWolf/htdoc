        ...
        <div class="product-content row">
            <div class="product-content-left row">
                ...
                <div class="product-content-left-small-img">
                    <img width="100%" src="../../../Admin/modules/quanlysp/uploads/<?php echo $row_chitiet['hinhanh']?>">
                    <img src="https://cdn.tgdd.vn/Products/Images/44/274539/asus-gaming-rog-flow-z13-gz301z-i7-ld110w-1-1.jpg">
                    <img src="https://cdn.tgdd.vn/Products/Images/44/274539/asus-gaming-rog-flow-z13-gz301z-i7-ld110w-3.jpg">
                    <img src="https://cdn.tgdd.vn/Products/Images/44/274539/asus-gaming-rog-flow-z13-gz301z-i7-ld110w-4.jpg ">
                    <img src="https://cdn.tgdd.vn/Products/Images/44/274539/asus-gaming-rog-flow-z13-gz301z-i7-ld110w-6.jpg">
                </div>
            </div>
            <div class="product-content-right">
                <div class="product-content-right-product-name">
                    <h1><?php echo $row_chitiet['tensanpham'] ?></h1>
                    <h4><span><?php echo $row_chitiet['masp'] ?><span style="color: red;"> *</span></h4><br><br><br>
                </div>
